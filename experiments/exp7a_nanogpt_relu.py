...
def main():
    ...
    model = GPT(vocab_size, block_size, n_layer, n_head, n_embd, activation='relu')
    ...
    with open('results/exp7a_relu_results.json', 'w') as f:
        json.dump(result, f, indent=2)
    
    print("\n✓ Results saved to: results/exp7a_relu_results.json")
    print("\n实验完成！")
