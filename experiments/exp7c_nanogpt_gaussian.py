"""
Experiment 7c: nanoGPT + LearnableGaussian 训练
"""
import torch
...
def main():
    print("="*70)
    print("Experiment 7c: nanoGPT + LearnableGaussian 训练")
    print("="*70)
    ...
    gaussian_params = sum(4 for _ in model.modules() if isinstance(_, LearnableGaussian))
